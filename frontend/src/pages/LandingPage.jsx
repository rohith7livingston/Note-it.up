...
const developers = [
  ...
  { name: 'Developer Three', role: 'Database & API Architect', github: 'https://github.com/PadalaDevisrisairam', linkedin: '#' },
  { name: 'Developer Four', role: 'orcehstrator & Real-time Specialist', github: '#', linkedin: '#' },
];
